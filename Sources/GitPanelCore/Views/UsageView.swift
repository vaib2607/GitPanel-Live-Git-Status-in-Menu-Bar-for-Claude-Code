        ...
        VStack(alignment: .leading, spacing: 8) {
                ...
                HStack(spacing: 16) {
                    VStack(alignment: .leading, spacing: 2) {
                        ...
                        Text(formatTokens(usage.tokens))
                            .font(.system(size: 13, weight: .semibold, design: .monospaced)) // Numbers/statistics are monospaced
                            .monospacedDigit()
                    }
                    ...
                    VStack(alignment: .leading, spacing: 2) {
                        ...
                        Text(String(format: "$%.2f", usage.cost))
                            .font(.system(size: 24, weight: .light, design: .monospaced)) // Numbers/statistics are monospaced
                            .monospacedDigit()
                    }
            ...
            VStack(alignment: .leading, spacing: 4) {
                ...
                TextField("e.g. 80%  ·  120 credits", text: Binding(
                    ...
                    .accessibilityLabel("Usage remaining manual override")
                    .accessibilityHint("Enter a custom usage value such as 80% or 120 credits")
            }
        }
    }
